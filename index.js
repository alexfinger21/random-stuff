...
let traffic = [
    new Car(road.getLaneCenter(1), -100, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
    new Car(road.getLaneCenter(2), -300, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
    new Car(road.getLaneCenter(0), -300, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
    new Car(road.getLaneCenter(1), -100, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
    new Car(road.getLaneCenter(1), -600, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
    new Car(road.getLaneCenter(2), -700, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
    new Car(road.getLaneCenter(0), -750, car.x, car.y, "DUMMY", 3, colorArray[getRandomInt(colorArray.length)]),
]
